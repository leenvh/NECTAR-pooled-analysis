...
nma = netmeta(TE = pairwise_reductions$coef, seTE=pairwise_reductions$se, treat1=pairwise_reductions$arm, treat2=pairwise_reductions$ref, studlab=pairwise_reductions$study, sm="MD", reference="ACT-PQ")
